...
#predicted_data  = inversescaler_pred_dict(data_list, scaler = scaler_y)

#data_list["train_y_pred"]
#data_list["train_y_pred"].reshape(-1, 1)
...
#metrics <- assess_model_prediction(predicted_data)
